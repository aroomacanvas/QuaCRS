<div class="container">
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<h1>Readme</h1>
			<h2>Installation Readme</h2>
			<p>
				<br>
                                <a href="http://bioserv.mps.ohio-state.edu/QuaCRS/QuaCRS_readme.txt">Latest Installation Readme</a> (Updated 6/27/14)
			</p>
			<br>
			<h2>Site Manual</h2>
			<p>
...
<h4>Sample View</h4>
This is the home view for the QuaCRS database. From any other page, it's accessible by 
clicking the <b>QuaCRS</b> logo at the top left of the page.
<br><br>
<t>There are four main aspects to the <b>Sample View</b> page:
<br>
<ol>
<li>The <b>Search Bar</b> – used to search for specific samples. To use, type a query and select <b>Search</b>.</li>
...
<li>The <b>Aggregate</b> button. This button is used to generate <b>Aggregate Results</b> for multiple samples (described below).
<li>The <b>Sample List</b> – Each row in this list is a different sample. The visible columns can be selected by the <b>Select Columns Menu</b>. The checkboxes to the left of each sample are used to select samples for use in <b>Aggregate Reports</b>. Clicking on a sample name will display <b>Sample Details</b> for that sample (described below).</li>
</ol>
<br>
...
<h4>Other Pages</h4>
The other pages in the QuaCRS database are mostly self-explanatory. They are accessible by clicking the links at the top of the page. The <b>Downloads</b> page contains links to download QuaCRS, as well as a version history. The <b>About Us</b> page contains information about the Ohio State University Comprehensive Cancer Center, as well as contact information for the maintainers of this site. Any questions can be directed to those email addresses. In addition to this manual, the <b>Readme</b> page contains a link to the latest Installation Readme for QuaCRS.
			</p>
		</div>
	</div>
</div>
